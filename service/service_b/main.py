...
from service.service_b.routers.router_b import service_b_router as service_b_router
...
async def lifespan(service_app: FastAPI):
    ...
    openapi_path = ROOT_DIR / 'docs/api/service_b.yaml'
...
app.include_router(service_b_router)
